...
<div class="justify-center">
	<div class="flex justify-center px-6 py-3">
		<label class="p-3 w-1/5 bg-white rounded-full text-black flex">
			<input
				use:focusOnMount
				class="w-full outline-none text-lg px-3 "
				placeholder="type here to filter..."
				bind:value={filterText}
			/>
			<svg class="h-[28px]" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve"><path d="M443.5,420.2L336.7,312.4c20.9-26.2,33.5-59.4,33.5-95.5c0-84.5-68.5-153-153.1-153S64,132.5,64,217s68.5,153,153.1,153
